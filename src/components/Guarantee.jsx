...
const Guarantee = () => {
  ...
  return (
    <section id="garantia" className="bg-[#040d1f] text-white" aria-labelledby="guarantee-block-heading">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 py-20 sm:px-6 lg:flex-row lg:px-8">
        <div className="w-full space-y-5">
          <span className="inline-flex items-center gap-2 rounded-full bg-primary/20 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-primary">
            Garantia blindada
          </span>
          ...
          <button
            ...
            className="mt-4 inline-flex items-center justify-center rounded-full bg-primary px-8 py-3 text-base font-semibold text-dark shadow-glow transition hover:scale-[1.05] hover:bg-primary/90"
          >
            Garantir meu e-book agora
          </button>
        </div>
        <div className="w-full max-w-md rounded-3xl border border-primary/30 bg-surface/80 p-8 text-center shadow-2xl backdrop-blur">
          <p className="text-sm font-semibold uppercase tracking-wide text-primary">Compromisso total</p>
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-black/60 p-4 text-sm text-slate-100">
