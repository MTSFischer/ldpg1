...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-dark text-white">
      ...
      <div className="absolute -inset-x-40 -top-40 h-96 bg-[radial-gradient(circle_at_top,rgba(249,115,22,0.25),transparent)]" aria-hidden="true"></div>
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-accent/20 px-4 py-2 text-sm font-semibold uppercase tracking-wide text-accent">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm font-medium text-slate-100">
            ...
            <span className="inline-flex items-center rounded-full bg-primary/20 px-3 py-1 text-xs uppercase tracking-wide text-primary">
          ...
          <div className="mt-8 flex flex-col gap-5 sm:flex-row sm:items-center sm:gap-6">
            <button
              ...
              className="w-full rounded-full bg-primary px-8 py-4 text-center text-lg font-semibold text-dark shadow-glow transition hover:scale-[1.05] hover:bg-primary/90 sm:w-auto"
            >
              Quero meu e-book
            </button>
            <div className="flex items-center gap-4 text-sm text-slate-200">
              <div className="text-left">
                ...
                <p className="text-2xl font-extrabold text-primary">{DISCOUNT_PRICE} hoje</p>
              </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative max-w-sm rounded-3xl border border-primary/20 bg-surface/80 p-6 shadow-2xl backdrop-blur">
            <img
              src={heroImage}
              loading="lazy"
              decoding="async"
            ...
            <div className="mt-6 space-y-2 text-sm text-slate-100">
              <p className="font-semibold text-primary">O que você vai dominar:</p>
